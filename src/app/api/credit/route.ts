...
import { getTotalPendingCredit, getRecentPaymentsSummary } from '@/lib/accounting';
...
export async function GET(req: NextRequest) {
  ...
  const { recentPaymentsAmount, recentPaymentsCount } = await getRecentPaymentsSummary();
